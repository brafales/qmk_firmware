...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ergodox(
      ...
      CTL_T(KC_ESCAPE), KC_A, KC_S, KC_D, KC_F, KC_G, //6 (third left row)
      LSFT_T(KC_LPRN), KC_Z, KC_X, KC_C, KC_V, KC_B, G(KC_V), //7 (fourth left row and big button)
      MO(1), KC_TRANSPARENT, KC_TRANSPARENT, TG(2), MO(2), //5 (bottom left row)
      ...
      MO(1), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_HYPR, //5 (bottom right row)
